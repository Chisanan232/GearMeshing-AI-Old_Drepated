...
class RunCreate(BaseModel):
    ...
    tenant_id: str = Field(..., description="The identifier of the tenant initiating the run.", examples=["tenant-123"])
...
class RunResume(BaseModel):
    ...
    approved_by: Optional[str] = Field(
        default=None, description="The identifier of the user or system authorizing the resume.", examples=["user-456"]
    )
    note: Optional[str] = Field(
        default=None, description="Optional note or reason for resuming the run.", examples=["Budget approved"]
    )
...
class RolePromptOverride(BaseModel):
    ...
    tenant_id: str = Field(..., description="The tenant identifier for which the override applies.")
    prompt: str = Field(
        ...,
...
class OperationData(BaseModel):
    ...
    status: str = Field(
        default="unknown", description="The execution status: 'success' or 'failed'.", examples=["success", "failed"]
    )
...
class ToolExecutionData(BaseModel):
    ...
    timestamp: Optional[datetime] = Field(
        default=None, description="The ISO 8601 timestamp when the tool was invoked.", examples=["2025-12-24T22:00:15Z"]
    )
...
class RunStartData(BaseModel):
    ...
    timestamp: Optional[datetime] = Field(
        default=None, description="The ISO 8601 timestamp when the run started.", examples=["2025-12-24T22:00:00Z"]
    )
...
class RunCompletionData(BaseModel):
    ...
    timestamp: Optional[datetime] = Field(
        default=None, description="The ISO 8601 timestamp when the run completed.", examples=["2025-12-24T22:05:00Z"]
    )
...
class RunFailureData(BaseModel):
    ...
    timestamp: Optional[datetime] = Field(
        default=None, description="The ISO 8601 timestamp when the run failed.", examples=["2025-12-24T22:03:45Z"]
    )
...
class SSEEventData(BaseModel):
    ...
    created_at: datetime = Field(
        ..., description="The ISO 8601 timestamp when the event was created.", examples=["2025-12-24T22:00:00Z"]
    )
    run_id: Optional[str] = Field(
        default=None,
    ...
    thinking: Optional[ThinkingData] = Field(
        default=None, description="Enriched thinking data (populated for thought_executed events)."
    )
    ...
    operation: Optional[OperationData] = Field(
        default=None, description="Enriched capability execution data (populated for capability_executed events)."
    )
    tool_execution: Optional[ToolExecutionData] = Field(
        default=None, description="Enriched tool invocation data (populated for tool_invoked events)."
    )
    approval_request: Optional[ApprovalRequestData] = Field(
        default=None, description="Enriched approval request data (populated for approval_requested events)."
    )
    approval_resolution: Optional[ApprovalResolutionData] = Field(
        default=None, description="Enriched approval resolution data (populated for approval_resolved events)."
    )
    run_start: Optional[RunStartData] = Field(
        default=None, description="Enriched run start data (populated for run.started events)."
    )
    run_completion: Optional[RunCompletionData] = Field(
        default=None, description="Enriched run completion data (populated for run.completed events)."
    )
