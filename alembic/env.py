...
# Use the authoritative SQLAlchemy Base from agent_core.repos.models
...
def generate_datetime_revision_id():
    """Generate a datetime-based revision ID in format: YYYYMMDD_HHMMSS"""
