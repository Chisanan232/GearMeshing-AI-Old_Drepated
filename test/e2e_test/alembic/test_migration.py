...
class TestMigrationDryRun:
    ...
    def test_migration_dry_run_creates_all_indexes(self):
        ...
        for index in required_indexes:
            assert f"CREATE INDEX {index}" in result.stdout, \
                f"Index {index} not created in migration"
...
class TestMigrationExecution:
        ...
        for table, expected_indexes in indexes_by_table.items():
            ...
            for expected_index in expected_indexes:
                assert expected_index in index_names, \
                    f"Index {expected_index} not found on table {table}"
    ...
    def test_migration_table_schema(self, database_url: str):
        ...
        required_columns = [
            ...
            "system_prompt_key", "model_provider", "model_name",
            "temperature", "max_tokens", "top_p",
            "capabilities", "tools", "autonomy_profiles",
            "done_when", "is_active", "tenant_id",
    ...
    def test_migration_idempotent(self, database_url: str):
        ...
        assert result2.returncode == 0 or "already at head" in result2.stdout.lower(), \
...
class TestMigrationDataIntegrity:
    ...
    def test_gm_policies_unique_constraint(self, database_url: str):
        ...
        has_tenant_unique = any(
            "tenant_id" in constraint["column_names"]
