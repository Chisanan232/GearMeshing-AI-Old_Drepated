...
class TestPolicy:
    ...
    def test_policy_creation_minimal_data(self):
        ...
        data = {"id": "policy_minimal", "tenant_id": "tenant_456", "config": config_data}
    ...
    def test_policy_string_field_length_validation(self):
        ...
        data = {"id": "x" * 65, "tenant_id": "tenant_456", "config": {}}  # Exceeds max_length=64

        with pytest.raises(ValidationError):
            Policy(**data)

        # Test tenant_id field length
        data = {"id": "policy_123", "tenant_id": "x" * 129, "config": {}}  # Exceeds max_length=128
    ...
    def test_policy_automatic_timestamps(self):
        ...
        data = {"id": "policy_auto", "tenant_id": "tenant_456", "config": {}}
    ...
    def test_policy_complex_config_data(self):
        ...
        complex_config = {
            "security": {
                ...
                "access_control": {
                    "authentication": {"required": True, "methods": ["mfa", "sso"], "session_timeout": 3600},
                    "authorization": {
                        "rbac_enabled": True,
            ...
            "resource_limits": {
                ...
                "storage": {"max_file_size_mb": 100, "max_total_storage_gb": 1000, "retention_days": 30},
            },
            "monitoring": {
                "logging": {"level": "INFO", "retention_days": 90, "include_sensitive_data": False},
                "metrics": {
                    "collection_interval_seconds": 60,
                    "enabled_metrics": ["cpu", "memory", "disk", "network"],
                    "alert_thresholds": {"cpu_usage_percent": 80, "memory_usage_percent": 85, "disk_usage_percent": 90},
                },
            },
            "compliance": {
        ...
        data = {"id": "policy_complex", "tenant_id": "tenant_456", "config": complex_config}
    ...
    def test_policy_config_validation_scenarios(self):
        ...
        for scenario in scenarios:
            data = {"id": f"policy_{scenario['name']}", "tenant_id": "tenant_456", "config": scenario["config"]}
    ...
    def test_policy_default_config(self):
        ...
        default_config = {"version": "1.0", "default_behavior": "safe", "fallback_policy": "deny"}

        data = {"id": "policy_default", "tenant_id": "tenant_456", "config": default_config}
    ...
    def test_policy_repr(self):
        ...
        data = {"id": "policy_repr", "tenant_id": "tenant_456", "config": {"mode": "test"}}
    ...
    def test_policy_config_edge_cases(self):
        ...
        for case in edge_cases:
            data = {"id": f"policy_edge_{list(case.keys())[0]}", "tenant_id": "tenant_456", "config": case}
    ...
    def test_policy_business_logic_validation(self):
        ...
        valid_business_config = {
            "business_hours": {"start": "09:00", "end": "17:00", "timezone": "UTC", "weekends_allowed": False},
            "approval_workflow": {
                "auto_approve_below_risk": "low",
                "require_manager_for": ["high", "critical"],
                "executive_approval_for": "critical",
            },
            "cost_controls": {"monthly_budget": 10000, "alert_threshold": 0.8, "auto_block_at_limit": True},
        }

        data = {"id": "policy_business", "tenant_id": "tenant_456", "config": valid_business_config}
