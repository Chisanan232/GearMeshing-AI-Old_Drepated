...
class TestAgentRunRepository:
    ...
    async def test_list_with_filters(self, repository, mock_session, sample_agent_run):
        ...
        filters = {"tenant_id": "tenant_456", "workspace_id": "workspace_789", "role": "developer", "status": "running"}
    ...
    async def test_role_filtering(self, repository, mock_session):
        ...
        for role in roles:
            ...
            run = AgentRun(id=f"run_{role}", role=role, objective="Test objective", status="running")
