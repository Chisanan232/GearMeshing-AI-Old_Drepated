...
class TestDatabaseConfigProviderGetModelConfig:
    ...
    def test_get_model_config_default_role(
        self, in_memory_db: Session, sample_configs: None
    ) -> None:
    ...
    def test_get_model_config_tenant_specific(
        self, in_memory_db: Session, sample_configs: None
    ) -> None:
    ...
    def test_get_model_config_tenant_fallback_to_default(
        self, in_memory_db: Session, sample_configs: None
    ) -> None:
        """Test that missing tenant config falls back to default."""
        provider: DatabaseConfigProvider = DatabaseConfigProvider(in_memory_db)

        model_config: ModelConfig = provider.get_model_config(
            "qa", tenant_id="unknown-tenant"
        )

        assert model_config.provider == "anthropic"
        assert model_config.model == "claude-3-5-sonnet"

    def test_get_model_config_different_providers(
        self, in_memory_db: Session, sample_configs: None
    ) -> None:
    ...
    def test_get_model_config_returns_domain_model(
        self, in_memory_db: Session, sample_configs: None
    ) -> None:
...
class TestDatabaseConfigProviderGetRoleConfig:
    ...
    def test_get_role_config_default_role(
        self, in_memory_db: Session, sample_configs: None
    ) -> None:
    ...
    def test_get_role_config_includes_model_config(
        self, in_memory_db: Session, sample_configs: None
    ) -> None:
    ...
    def test_get_role_config_includes_capabilities(
        self, in_memory_db: Session, sample_configs: None
    ) -> None:
    ...
    def test_get_role_config_includes_tools(
        self, in_memory_db: Session, sample_configs: None
    ) -> None:
    ...
    def test_get_role_config_includes_autonomy_profiles(
        self, in_memory_db: Session, sample_configs: None
    ) -> None:
    ...
    def test_get_role_config_tenant_specific(
        self, in_memory_db: Session, sample_configs: None
    ) -> None:
    ...
    def test_get_role_config_tenant_fallback(
        self, in_memory_db: Session, sample_configs: None
    ) -> None:
        """Test that missing tenant config falls back to default."""
        provider: DatabaseConfigProvider = DatabaseConfigProvider(in_memory_db)

        role_config: RoleConfig = provider.get_role_config(
            "qa", tenant_id="unknown-tenant"
        )
    ...
    def test_get_role_config_returns_domain_model(
        self, in_memory_db: Session, sample_configs: None
    ) -> None:
...
class TestDatabaseConfigProviderListRoles:
    ...
    def test_list_roles_all_active(
        self, in_memory_db: Session, sample_configs: None
    ) -> None:
    ...
    def test_list_roles_excludes_inactive(
        self, in_memory_db: Session, sample_configs: None
    ) -> None:
    ...
    def test_list_roles_tenant_specific(
        self, in_memory_db: Session, sample_configs: None
    ) -> None:
    ...
    def test_list_roles_no_tenant_configs(
        self, in_memory_db: Session, sample_configs: None
    ) -> None:
    ...
    def test_list_roles_returns_list_of_strings(
        self, in_memory_db: Session, sample_configs: None
    ) -> None:
...
class TestDatabaseConfigProviderFactory:
    ...
    def test_get_db_config_provider_returns_provider(
    ...
    def test_get_db_config_provider_with_session(
        self, in_memory_db: Session, sample_configs: None
    ) -> None:
...
class TestDatabaseConfigProviderIntegration:
    ...
    def test_get_model_config_then_role_config(
        self, in_memory_db: Session, sample_configs: None
    ) -> None:
    ...
    def test_multiple_roles_different_providers(
        self, in_memory_db: Session, sample_configs: None
    ) -> None:
    ...
    def test_tenant_override_priority(
        self, in_memory_db: Session, sample_configs: None
    ) -> None:
